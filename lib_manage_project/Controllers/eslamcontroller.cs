...
using lib_manage_project.Model;

namespace lib_manage_project.Controllers
{
    public class eslamcontroller : Controller
    {
        ...
        // GET: eslamcontroller/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: eslamcontroller/Create
